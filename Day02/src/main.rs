...
fn main() {
    ...
    for line in parts {
        ...
        for game in games {
            ...
            if (ball_counts[0] > balls_available[0])
                || (ball_counts[1] > balls_available[1])
                || (ball_counts[2] > balls_available[2])
            {
    ...
    for line in lines {
        ...
        for game in games {
            ...
            for ball in balls {
                ...
                let ball_color = ball[1];
                if ball_color == "red" {
                    if ball_counts[0] < ball_count {
                        ball_counts[0] = ball_count;
                    }
                } else if ball_color == "green" {
                    if ball_counts[1] < ball_count {
                        ball_counts[1] = ball_count;
                    }
                } else if ball_color == "blue" {
                    if ball_counts[2] < ball_count {
                        ball_counts[2] = ball_count;
                    }
                }
            }
        }
        sum += ball_counts[0] * ball_counts[1] * ball_counts[2];
    }
    println!("Sum2: {}", sum);
}
